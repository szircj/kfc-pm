...
forceAutoTeam()
{
	...
	if((AlliedPlayers.size > (AxisPlayers.size + 1)) || (AxisPlayers.size > (AlliedPlayers.size + 1)))
	{
		if(AlliedPlayers.size > (AxisPlayers.size + 1) && self.pers["team"] == "allies")
		{
			self changeTeam("axis");
			self iprintln("^1NO ^7team stacking please.");
		}
		else if(AxisPlayers.size > (AlliedPlayers.size + 1) && self.pers["team"] == "axis")
		{
